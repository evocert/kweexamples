Demonstration of creating an encrypted stateful API using the KWE server and CryptoJS. Based on <a href="https://github.com/evocert/kweexamples/tree/main/src/api_stateful" target="_blank">Stateful API</a>
