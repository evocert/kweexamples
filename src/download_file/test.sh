...
curl -X POST -H "Content-Type: application/json" --data '{"cmd":"wget","url":"http://skullquake.dedicated.co.za/kweexamples/src/scripted_binary_response/src","out":"-"}' "$URL" --output -
curl -X POST -H "Content-Type: application/xml" --data '<?xml version="1.0" encoding="UTF-8"?><api><cmd>wget</cmd><url>http://skullquake.dedicated.co.za/kweexamples/src/scripted_binary_response/src</url><out>-</out></api>' "$URL" --output -
